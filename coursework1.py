...
def vk_photos_get(access_token, file, id_account):
    #access_token = 'vk1.a.83nfG36mo3bz79IH9dkQc-aLGgY8Bl0m4PShfziqWJfoTX7d2eAyy4snYRLEwwW-uMjVAmfF6lOMJTAO9T6gjIbt5XpCrFEiLxtHUyHFsbZOQ8ZyK9QqH0-9WKWQnzgsuND2GBnZF-4yf_kHvN1rAXCPktoxQvuHtVLHHrsKfks09b3MSLKz08qUmIEwCR5q'
...
if __name__ == '__main__':
    ...
    uploader.upload_file_to_disk(disk_file_path, file)

print(vk_photos_get(token_vk, file, id_account))




#'/file_photos_vk.txt
'vk1.a.83nfG36mo3bz79IH9dkQc-aLGgY8Bl0m4PShfziqWJfoTX7d2eAyy4snYRLEwwW-uMjVAmfF6lOMJTAO9T6gjIbt5XpCrFEiLxtHUyHFsbZOQ8ZyK9QqH0-9WKWQnzgsuND2GBnZF-4yf_kHvN1rAXCPktoxQvuHtVLHHrsKfks09b3MSLKz08qUmIEwCR5q'
"AQAAAAAyhekUAADLWyLGJq9g806MkylfQ0tnanQ"